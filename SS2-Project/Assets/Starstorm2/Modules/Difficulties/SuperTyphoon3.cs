...
namespace SS2
{
    ...
    public class SuperTyphoon3 : SS2Difficulty
    {
        public override SS2AssetRequest<SerializableDifficultyDef> AssetRequest => SS2Assets.LoadAssetAsync<SerializableDifficultyDef>("SuperTyphoon3", SS2Bundle.Base);
