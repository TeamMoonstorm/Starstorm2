...
namespace SS2
{
    public class Cyclone1 : SS2Difficulty
    {
        public override SS2AssetRequest<SerializableDifficultyDef> AssetRequest => SS2Assets.LoadAssetAsync<SerializableDifficultyDef>("Cyclone1", SS2Bundle.Base);
