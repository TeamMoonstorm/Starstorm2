...
namespace SS2
{
    ...
    public class SuperTyphoon2 : SS2Difficulty
    {
        public override SS2AssetRequest<SerializableDifficultyDef> AssetRequest => SS2Assets.LoadAssetAsync<SerializableDifficultyDef>("SuperTyphoon2", SS2Bundle.Base);
