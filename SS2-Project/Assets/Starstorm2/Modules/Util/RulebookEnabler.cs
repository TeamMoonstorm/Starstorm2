...
public class RulebookEnabler : MonoBehaviour
{
    ...
    internal static IEnumerator Init()
    {
        ...
        ruleCategoryDef.color = Color.red;
        ...
        ExtendedRuleChoiceDef enabledChoice = rule.AddExtendedRuleChoiceDef("SS2_RULE_TEST_ENABLED", "Enabled");
        ...
        ExtendedRuleChoiceDef thirdThingChoice = rule.AddExtendedRuleChoiceDef("SS2_RULE_TEST_THIRDTHIND", "ThirdThing");
        ...
        RuleCatalogExtras.AddRuleToCatalog(rule, ruleCategoryIndex);
