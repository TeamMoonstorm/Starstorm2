...
{
    public sealed class HuntressAltSkin3Achievement : BaseAchievement
    {
        ...
        private class HuntressAltSkin3ServerAchievement : BaseServerAchievement
        {
            ...
            private void OnCrystalGrabbed(GameObject obj)
            {
                ...
                if (scc != null)
                {
                    ...
                    if (scc.bodyIndex == BodyCatalog.FindBodyIndex("HuntressBody") && scc.skinUnlockID == 3)
                    {
                        Grant();
                    }
                }
