...
{
    public sealed class CommandoAltSkin2Achievement : BaseAchievement
    {
        ...
        private class CommandoAltSkin2ServerAchievement : BaseServerAchievement
        {
            ...
            private void OnCrystalGrabbed(GameObject obj)
            {
                ...
                if (scc != null)
                {
                    ...
                    if (scc.bodyIndex == BodyCatalog.FindBodyIndex("CommandoBody") && scc.skinUnlockID == 2)
                    {
                        Grant();
                    }
                }
