...
{
    public sealed class CommandoAltSkin4Achievement : BaseAchievement
    {
        ...
        private class CommandoAltSkin4ServerAchievement : BaseServerAchievement
        {
            ...
            private void OnCrystalGrabbed(GameObject obj)
            {
                ...
                if (scc != null)
                {
                    ...
                    if (scc.bodyIndex == BodyCatalog.FindBodyIndex("CommandoBody") && scc.skinUnlockID == 4)
                    {
                        Grant();
                    }
                }
