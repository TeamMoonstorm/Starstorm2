...
{
    public sealed class CommandoAltSkin3Achievement : BaseAchievement
    {
        ...
        private class CommandoAltSkin3ServerAchievement : BaseServerAchievement
        {
            ...
            private void OnCrystalGrabbed(GameObject obj)
            {
                ...
                if (scc != null)
                {
                    ...
                    if (scc.bodyIndex == BodyCatalog.FindBodyIndex("CommandoBody") && scc.skinUnlockID == 3)
                    {
                        Grant();
                    }
                }
