...
{
    public sealed class HuntressAltSkin2Achievement : BaseAchievement
    {
        ...
        private class HuntressAltSkin2ServerAchievement : BaseServerAchievement
        {
            ...
            private void OnCrystalGrabbed(GameObject obj)
            {
                ...
                if (scc != null)
                {
                    ...
                    if (scc.bodyIndex == BodyCatalog.FindBodyIndex("HuntressBody") && scc.skinUnlockID == 2)
                    {
                        Grant();
                    }
                }
