...
{
	public class FireFearProjectile : BaseSkillState
	{
		...
		public override void OnEnter()
		{
			...
			StartAimMode();
			base.PlayAnimation("Gesture, Override", "FireUtility", "Utility.playbackRate", this.duration);
		}
		...
		private void Fire()
		{
			...
			if (base.isAuthority)
			{
				...
				damageType.AddModdedDamageType(SS2.Survivors.NemExecutioner.fearOnHit);
