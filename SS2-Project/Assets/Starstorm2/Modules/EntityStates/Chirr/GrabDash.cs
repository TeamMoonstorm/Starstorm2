...
namespace EntityStates.Chirr
{
    public class GrabDash : BaseSkillState
    {
        ...
        public static float dashSpeed = 14f;
        public static float minGrabRadius = 4f;
        public static float maxGrabRadius = 8f;
        public static float grabSearchFrequency = 5f;
        ...
        {
            base.OnEnter();
            this.speedCurve = AnimationCurve.EaseInOut(0, 1, 1f, 0f);
        ...
        public override void FixedUpdate()
        {
            ...
            float dashSpeed = this.speedCurve.Evaluate(this.stopwatch / baseDuration) * GrabDash.dashSpeed;
            ...
            if(grabSearchTimer <= 0f)
            {
                ...
                this.debugSphere.transform.position = base.characterBody.corePosition;
                this.debugSphere.transform.localScale = Vector3.one * minGrabRadius;
                float grabRadius = Mathf.Lerp(minGrabRadius, maxGrabRadius, this.stopwatch / baseDuration);
