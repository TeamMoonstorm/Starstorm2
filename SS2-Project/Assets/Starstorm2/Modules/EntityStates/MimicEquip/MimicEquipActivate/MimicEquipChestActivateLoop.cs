...
{
    public class MimicEquipChestActivateLoop : BaseCharacterMain
	{
		...
		public override void OnEnter()
		{
			...
			if (lThruster)
			{
				UnityEngine.Object.Instantiate<GameObject>(SS2.Monsters.MimicEquip.jetVFX, lThruster);
			}

			if (rThruster)
			{
				UnityEngine.Object.Instantiate<GameObject>(SS2.Monsters.MimicEquip.jetVFX, rThruster);
			}
		}
		...
		public override void FixedUpdate()
		{
			...
			if (characterMotor)
			{
				if (fixedAge >= duration)
				{
                    ...
                    if (isAuthority)
                    {
						outer.SetNextState(new MimicEquipChestActivateExit());
					}
				}
			}
		}
		...
		protected BlastAttack.Result DetonateAuthority()
		{
			...
			EffectManager.SpawnEffect(SS2.Monsters.MimicEquip.leapLandVFX, effectData, transmit: true);
