...
namespace Moonstorm.Starstorm2.Items
{
    ...
    public sealed class ErraticGadget : ItemBase
    {
        ...
        [RooConfigurableField(SS2Config.IDItem, ConfigDesc = "Base crit chance granted by the first stack of Erratic Gadget.")]
        [TokenModifier(token, StatTypes.Default, 0)]
        public static float extraCrit = 10f;

        [RooConfigurableField(SS2Config.IDItem, ConfigDesc = "Extra damage that crits deal per stack of Erratic Gadget. (1 = 100%)")]
