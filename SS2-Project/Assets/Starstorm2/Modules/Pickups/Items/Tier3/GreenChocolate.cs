...
namespace Moonstorm.Starstorm2.Items
{
    public sealed class GreenChocolate : ItemBase
    {
        ...
        [ConfigurableField(SS2Config.IDItem, ConfigDesc = "Percentage of max hp that must be lost for Green Chocolate's effect to proc. (1 = 100%)")]
        [TokenModifier(token, StatTypes.MultiplyByN, 0, "100")]
        public static float damageThreshold = 0.2f;

        [ConfigurableField(SS2Config.IDItem, ConfigDesc = "Percent damage reduction that the damage in excess of the above threshold (base value 20%) is reduced by. (1 = 100%)")]
        ...
        [ConfigurableField(SS2Config.IDItem, ConfigDesc = "Crit chance increase from the buff. (1 = 1% crit chance)")]
