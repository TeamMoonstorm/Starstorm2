...
namespace Moonstorm.Starstorm2.Monsters
{
    ...
    public sealed class LampBoss : MonsterBase
    {
        ...
        private MSMonsterDirectorCard defaultCard = SS2Assets.LoadAsset<MSMonsterDirectorCard>("msmdcLampBoss", SS2Bundle.Indev);
        private MSMonsterDirectorCard chainedCard = SS2Assets.LoadAsset<MSMonsterDirectorCard>("msmdcLampBossChained", SS2Bundle.Indev);
