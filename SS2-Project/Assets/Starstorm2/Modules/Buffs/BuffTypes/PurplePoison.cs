...
namespace Moonstorm.Starstorm2.Buffs
{
    ...
    {
        public override BuffDef BuffDef { get; } = SS2Assets.LoadAsset<BuffDef>("bdPurplePoison");
        ...
        {
            [BuffDefAssociation]
            private static BuffDef GetBuffDef() => SS2Assets.LoadAsset<BuffDef>("bdPurplePoison");
        }
    }
}
