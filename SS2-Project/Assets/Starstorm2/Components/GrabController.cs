...
namespace Moonstorm.Starstorm2.Components
{
    ...
    // would be good to network victim position for clients so it doesnt lag behind
    ...
    public class GrabController : NetworkBehaviour
    {
        ...
        public void UpdateVictimPosition() // would be great to network this better for clients..........
        {
            ...
            if (this.victimInfo.bodyStateMachine && this.victimInfo.hasEffectiveAuthority)
            {
                ...
                if (this.victimInfo.bodyStateMachine.state.GetType() != this.grabState.stateType && this.ShouldForcePassengerState())
                {
                    ...
                    if ((this.victimInfo.bodyStateMachine.CanInterruptState(InterruptPriority.Vehicle) || this.victimInfo.bodyStateMachine.IsInInitialState()))
                    {
                        ...
                        if (shouldLog) SS2Log.Warning("GrabController.ForcePassengerState: Interrupted " + this.victimInfo.body);
        ...
        public void AssignVictim(GameObject bodyObject)
        {
            ...
            if (bodyObject)
            {
                ...
                {
                    component.currentVehicle.EjectPassenger(bodyObject); // need to do this, and also for grabs somehow
                }
            }
        ...
        private void StartGrab(GameObject victim)
        {
            ...
            {
                //if (collider.gameObject.layer == LayerIndex.entityPrecise) // DO THIS ASAP instead of linq
                //{
        ...
        private void EndGrab(GameObject victim)
        {
            ...
            // should have this be a default callback that can be overridden
