public class AkWwiseInitializationSettings : AkCommonPlatformSettings
{
	...
	private static readonly string[] AllGlobalValues = new[]
	{
		...
		"UserSettings.m_SpatialAudioSettings.m_EnableDirectPathDiffraction",
		"UserSettings.m_SpatialAudioSettings.m_EnableTransmission",
	...
	public static bool InitializeSoundEngine()
	{
		...
		{
			UnityEngine.Debug.LogError("WwiseUnity: Failed to initialize the sound engine. Reason: " + initResult.ToString());
			AkSoundEngine.Term();
			return false;
		}
